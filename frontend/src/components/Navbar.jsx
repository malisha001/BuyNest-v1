...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    // Apply the padding dynamically to the body or content wrapper
        ...
        <div className='flex items-center gap-6'>
          ...
          <div className='group relative'>
            ...
            <div className='group-hover:block hidden absolute dropdown-menu right-0 mt-2 py-2 w-48 bg-white border border-gray-200 shadow-lg rounded-lg text-gray-600 transition-all duration-300'>
              ...
              <p className='cursor-pointer px-4 py-2 hover:bg-gray-100 hover:text-black transition-colors duration-200'>Order</p>
              <p className='cursor-pointer px-4 py-2 hover:bg-gray-100 hover:text-black transition-colors duration-200'>Logout</p>
            </div>
          </div>
          ...
          {/* Live Assistance Button with Glowing Border */}
          <button
